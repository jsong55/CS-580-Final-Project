...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.6\linewidth]{robotwheels.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.6\linewidth]{robotsensors.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.6\linewidth]{robotelectronics.png}
